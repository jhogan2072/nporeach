...
privilege5 = Privilege.create(:name => 'admin.privileges.names.personalinfo', :description => 'admin.privileges.descriptions.personalinfo', :controller => 'users', :category => 'PERSONAL', :actions => 24)
privilege6 = Privilege.create(:name => 'admin.privileges.names.changepassword', :description => 'admin.privileges.descriptions.changepassword', :controller => 'users', :category => 'PERSONAL', :actions => 24)
privilege7 = Privilege.create(:name => 'admin.privileges.names.addmembers', :description => 'admin.privileges.descriptions.addmembers', :controller => 'users', :category => 'PERSONAL', :actions => 62)
...
MenuItem.create(:name => 'admin.menu_items.names.personalinfo', :help_text => 'admin.privileges.descriptions.personalinfo', :category => 'PERSONAL', :controller => 'users', :action => 'edit')
MenuItem.create(:name => 'admin.privileges.names.changepassword', :help_text => 'admin.privileges.descriptions.changepassword', :category => 'PERSONAL', :controller => 'users', :action => 'edit')
MenuItem.create(:name => 'admin.privileges.names.addmembers', :help_text => 'admin.privileges.descriptions.addmembers', :category => 'PERSONAL', :controller => 'users', :action => 'members')
